...
{
    public class MyModularMechs : IPlugin
    {
        //Just use NLog, like we all do... or don't and implement your own logging...
        private static readonly Lazy<Logger> s_ObjLogger = new Lazy<Logger>(LogManager.GetCurrentClassLogger);
        private static Logger Log => s_ObjLogger.Value;

        //If you want this plugin NOT to be visible with the default "ModularMechs.MyModularMechs"
        public override string ToString()
        {
            return "Modular Mechs";
        }
        ...
        public string GetSaveToFileElement(Character input)
        {
            try
            {
                ...
                //b) actually use it ;)
                string savesetting = "This Char was saved with Modular Mechs enabled!";
        ...
        {
            TabPage tabMechs = new System.Windows.Forms.TabPage();
            tabMechs.Name = "tabMechs";
            tabMechs.BackColor = System.Drawing.SystemColors.Control;
            tabMechs.Location = new System.Drawing.Point(4, 22);
            tabMechs.Name = "tabMechs";
            tabMechs.Padding = new System.Windows.Forms.Padding(3);
            tabMechs.Size = new System.Drawing.Size(977, 631);
            tabMechs.TabIndex = 50;
            tabMechs.Tag = "Tab_Mechs";
            tabMechs.Text = "Mechs";
            //here you can add (or remove!) tabs from frmCareer
            //as well as manipulate every single tab
            // If you do this all synchronously, just make sure you return the final result wrapped in a task
            return Task.FromResult<ICollection<TabPage>>(new List<TabPage> { tabMechs });
        }
        ...
        public Task<ICollection<TabPage>> GetTabPages(CharacterCreate input, CancellationToken token = default)
        {
            ...
            tabMechs.Tag = "Tab_Mechs";
            tabMechs.Text = "Mechs";
            ModularMechsPage modularMechsPage = new ModularMechsPage();
            tabMechs.Controls.Add(modularMechsPage);
        ...
        public void SetIsUnitTest(bool isUnitTest)
        {
            ...
            if (isUnitTest)
                Console.WriteLine("MyModularMechs is in a Unit Test!");
        }
